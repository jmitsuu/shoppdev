...
export function CardProduct({ product }: CardProductProps) {
  return (
    <NavLink to={`/product/${product._id}`}>
      <div className="cursor-pointer group relative h-96  w-56 border border-orange-600  bg-black  transition-all  rounded-md bg-opacity-5 flex flex-col justify-center items-center p-2">
        <div className="relative transition-all w-full flex justify-center ">
          ...
          <div className="absolute bottom-0 opacity-90 left-0 min-w-52 h-10 rounded-sm md:bg-transparent bg-black group-hover:bg-black flex items-center justify-center">
        ...
        <div className=" w-full">
          <h2 className="text-xs font-bold mt-5 uppercase">{product.title}</h2>
